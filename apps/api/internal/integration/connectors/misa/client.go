...
const (
	// defaultBaseURL is Integration Open API (publish). Web API smoke SoT uses
	// https://testapp.meinvoice.vn/api — see docs/31-misa-meinvoice-smoke.md and
	// https://doc.meinvoice.vn/webapi/intro.html (do not mix hosts).
